...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_W:
        m_camera.TranslateForward(0.5);
        break;
    case Qt::Key_S:
        m_camera.TranslateForward(-0.5);
        break;
    case Qt::Key_A:
        m_camera.TranslateRight(-0.5);
        break;
    case Qt::Key_D:
        m_camera.TranslateRight(0.5);
        break;
    case Qt::Key_Q:
        m_camera.TranslateUp(0.5);
        break;
    case Qt::Key_E:
        m_camera.TranslateUp(-0.5);
        break;
    case Qt::Key_Down:
        m_camera.rotateRight(5);
        break;
    case Qt::Key_Up:
        m_camera.rotateRight(-5);
        break;
    ...
    rendered_image = rasterizer.RenderScene(m_camera);
