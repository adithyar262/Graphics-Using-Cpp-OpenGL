    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->TranslateX_Slider, SIGNAL(valueChanged(int)), ui->mygl, SLOT(slot_addTranslateXNode(int)));
    connect(ui->TranslateY_Slider, SIGNAL(valueChanged(int)), ui->mygl, SLOT(slot_addRotateLegUp(int)));
    connect(ui->ScaleY_Slider, SIGNAL(valueChanged(int)), ui->mygl, SLOT(slot_addRotateLegDown(int)));
    // connect(ui->Rotate_Dial, SIGNAL(valueChanged(float)), ui->mygl, SLOT(slot_addRotateArmUpNode(int)));
}
