...
MyGL::MyGL(QWidget *parent)
    : QOpenGLWidget(parent),
      ...
      progPostProcessCustomCRT(&glContext),
...
void MyGL::initializeGL() {
    ...
    printGLErrorLog();
    progPostProcessCustomCRT.createAndCompileShaderProgram("crt.vert.glsl",
                                                        "crt.frag.glsl");
    printGLErrorLog();
...
void MyGL::slot_ChangePostShader(int idx) {
    ...
    case 3:
        ...
        break;
    case 4:
        selectedPostProcessShader = &progPostProcessCustomCRT;
        break;
    default:
        selectedPostProcessShader = &progPostProcessNoOp;
        break;
