...
private:
    ...
    ShaderProgram m_progWeather; // A screen-space shader for creating the weather effects
    ShaderProgram m_proInventory;    // for user block inverntory
    Quad m_geomQuad;
    Pet m_bird;
    Weather m_weather;
