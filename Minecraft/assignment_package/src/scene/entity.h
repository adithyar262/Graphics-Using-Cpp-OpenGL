...
struct InputBundle {
    ...
    bool rPressed, n1Pressed, n2Pressed;
    bool iPressed;
    float mouseX, mouseY;
    bool centering;
    ...
    InputBundle()
        ...
        fPressed(false),
        upPressed(false), downPressed(false), rightPressed(false), leftPressed(false),
        spacePressed(false), shiftPressed(false),
        rPressed(false), n1Pressed(false), n2Pressed(false), iPressed(false),
